# Spark-NLP-Server OpenAPI Specification
[![Build Status](https://travis-ci.com/JohnSnowLabs/spark-nlp-server.svg?branch=master)](https://travis-ci.com/JohnSnowLabs/spark-nlp-server)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://johnsnowlabs.github.io/spark-nlp-server/)
- [SwaggerUI](https://johnsnowlabs.github.io/spark-nlp-server/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://johnsnowlabs.github.io/spark-nlp-server/openapi.json) [YAML](https://johnsnowlabs.github.io/spark-nlp-server/openapi.yaml)
